...
def render_projects_page():
    ...
    if not projs.empty:
        ...
        st.markdown('<div class="table-header"><div style="flex: 1;">Job No</div><div style="flex: 5;">Project Name</div><div style="flex: 2;">Status</div></div>', unsafe_allow_html=True)
